...
<form method="post" class="form-horizontal" action="index.php?action=addSefer">
<h3 class="text-center">Enter sefer info to add sefer to database</h3>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="category" name="category" required <?php if(isset($errors) && !empty($name)) echo "value = $category" ?>>
        </div>
    </div>
    <div class="form-group">
...
<?php if(isset($selectedSefer)): ?>
    <div class="alert alert-success">
        ...
        category: <?=$selectedSefer['category'] ?><br>
    </div>
